    ...
    <form wire:submit.prevent="{{ $this->isEdit ? 'update' : 'store' }}" class="space-y-4">
        ...
        <div>
            ...
            <input wire:model.defer="name" type="text" required placeholder="Full Name"
                class="mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md text-sm text-gray-800 dark:text-gray-100" />
        ...
        <div>
            ...
            <textarea wire:model.defer="address" required rows="2"
                class="mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md text-sm text-gray-800 dark:text-gray-100"></textarea>
