    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        ...
        <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-4">
            ...
            <div
                ...
                <div class="flex items-center gap-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                     ...
                     <a href="{{route('admin.students.index')}}" class="hover:text-green-400"> Manage Students </a>
                </div>
            ...
            <div
                ...
                <div class="flex items-center gap-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                  ...
                  <a href="{{route('admin.dashboard')}}" class="hover:text-green-400">Manage Teachers </a>
            ...
            <div
                ...
                <div class="flex items-center gap-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                       ...
                       <a href="" class="hover:text-green-400"> Manage Parents</a>
                </div>
                <div class="mt-2 text-3xl text-center p-8 font-bold hover:bg-red-200 text-gray-900 dark:text-white">
            ...
            <div
                ...
                <div class="mt-2 text-3xl text-center p-2  font-bold text-gray-900 dark:text-white">Work in Progress</div>
            </div>
            <div
                class="relative flex flex-col justify-between aspect-video rounded-xl border border-neutral-200 bg-white p-4 dark:border-neutral-700 dark:bg-neutral-900">
                <div class="flex items-center gap-2 text-sm font-medium text-gray-500 dark:text-gray-400">
