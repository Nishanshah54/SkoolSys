            ...
            @if (auth()->user()->role === 'student')
                <flux:navlist variant="outline">
                    ...
                    :current="request()->routeIs('student.profile')" --}} wire:navigate>
                        ...
                        <flux:navlist.item icon="calendar" :href="route('student.timetable')"
                            :current="request()->routeIs('student.timetable')" wire:navigate>
                            {{ __('Timetable') }}
                        </flux:navlist.item>
                    ...
                    :current="request()->routeIs('student.results')" --}} wire:navigate>
                        ...
                        <flux:navlist.item icon="clipboard-document-check" {{-- :href="route('student.assignments')"
                    :current="request()->routeIs('student.assignments')" --}} wire:navigate>
                            {{ __('Assignments') }}
                        </flux:navlist.item>

                        <flux:navlist.item icon="newspaper" {{-- :href="route('student.updates')"
                    :current="request()->routeIs('student.updates')" --}} wire:navigate>
                            {{ __('Updates') }}
                        </flux:navlist.item>

                        <flux:navlist.item icon="calendar-days" {{-- :href="route('student.calendar')"
                    :current="request()->routeIs('student.calendar')" --}} wire:navigate>
                            {{ __('Calendar') }}
                        </flux:navlist.item>
                    </flux:navlist.group>
                </flux:navlist>
