    ...
    {{-- Login Form --}}
    <div
        class="flex flex-col justify-center items-center m-4 py-5 px-5 text-black dark:text-white w-full h-full rounded-t-lg lg:rounded-t-none lg:rounded-e-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
